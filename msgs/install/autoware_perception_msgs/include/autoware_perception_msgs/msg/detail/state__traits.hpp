...
#ifndef AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__STATE__TRAITS_HPP_
#define AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__STATE__TRAITS_HPP_
...
inline void to_yaml(
  const autoware_perception_msgs::msg::State & msg,
...
inline std::string to_yaml(const autoware_perception_msgs::msg::State & msg)
{
...
template<>
inline const char * data_type<autoware_perception_msgs::msg::State>()
{
  return "autoware_perception_msgs::msg::State";
}

template<>
inline const char * name<autoware_perception_msgs::msg::State>()
{
  return "autoware_perception_msgs/msg/State";
}

template<>
struct has_fixed_size<autoware_perception_msgs::msg::State>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<autoware_perception_msgs::msg::State>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<autoware_perception_msgs::msg::State>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__STATE__TRAITS_HPP_

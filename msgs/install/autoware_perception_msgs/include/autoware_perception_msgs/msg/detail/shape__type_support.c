...
static rosidl_typesupport_introspection_c__MessageMember Shape__rosidl_typesupport_introspection_c__Shape_message_member_array[3] = {
  {
    "type",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_perception_msgs, msg, Shape)() {
  Shape__rosidl_typesupport_introspection_c__Shape_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Vector3)();
  Shape__rosidl_typesupport_introspection_c__Shape_message_member_array[2].members_ =

...
// Member `semantic`
#include "autoware_perception_msgs/msg/semantic.h"
// Member `semantic`
#include "autoware_perception_msgs/msg/detail/semantic__rosidl_typesupport_introspection_c.h"
// Member `state`
#include "autoware_perception_msgs/msg/state.h"
// Member `state`
#include "autoware_perception_msgs/msg/detail/state__rosidl_typesupport_introspection_c.h"
// Member `shape`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_perception_msgs__msg__DynamicObject__init(message_memory);
}

void DynamicObject__rosidl_typesupport_introspection_c__DynamicObject_fini_function(void * message_memory)
{
  autoware_perception_msgs__msg__DynamicObject__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember DynamicObject__rosidl_typesupport_introspection_c__DynamicObject_message_member_array[4] = {
  {
    ...
    offsetof(autoware_perception_msgs__msg__DynamicObject, id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs__msg__DynamicObject, semantic),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs__msg__DynamicObject, state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs__msg__DynamicObject, shape),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers DynamicObject__rosidl_typesupport_introspection_c__DynamicObject_message_members = {
  ...
  4,  // number of fields
  sizeof(autoware_perception_msgs__msg__DynamicObject),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_perception_msgs, msg, DynamicObject)() {
  ...
  DynamicObject__rosidl_typesupport_introspection_c__DynamicObject_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_perception_msgs, msg, State)();

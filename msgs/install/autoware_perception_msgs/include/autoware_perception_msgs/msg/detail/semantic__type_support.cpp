...
{
  new (message_memory) autoware_perception_msgs::msg::Semantic(_init);
}

void Semantic_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_perception_msgs::msg::Semantic *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Semantic_message_member_array[2] = {
  {
    ...
    offsetof(autoware_perception_msgs::msg::Semantic, type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::Semantic, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Semantic_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_perception_msgs::msg::Semantic),
...
get_message_type_support_handle<autoware_perception_msgs::msg::Semantic>()
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::Semantic_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, Semantic)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::Semantic_message_type_support_handle;
}

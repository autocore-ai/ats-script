...
{
  new (message_memory) autoware_perception_msgs::msg::Feature(_init);
}

void Feature_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_perception_msgs::msg::Feature *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Feature_message_member_array[2] = {
  {
    ...
    offsetof(autoware_perception_msgs::msg::Feature, cluster),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::Feature, roi),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Feature_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_perception_msgs::msg::Feature),
...
get_message_type_support_handle<autoware_perception_msgs::msg::Feature>()
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::Feature_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, Feature)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::Feature_message_type_support_handle;
}

...
#ifndef AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__BATTERY_STATUS__FUNCTIONS_H_
#define AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__BATTERY_STATUS__FUNCTIONS_H_
 ...
 * calls
 * autoware_vehicle_msgs__msg__BatteryStatus__init().
...
/**
 * It calls
 * autoware_vehicle_msgs__msg__BatteryStatus__fini()
 ...
 * autoware_vehicle_msgs__msg__BatteryStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_vehicle_msgs__msg__BatteryStatus__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__BATTERY_STATUS__FUNCTIONS_H_

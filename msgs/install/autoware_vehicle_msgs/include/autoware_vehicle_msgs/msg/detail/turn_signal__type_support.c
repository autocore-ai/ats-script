...
#include <stddef.h>
#include "autoware_vehicle_msgs/msg/detail/turn_signal__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_vehicle_msgs__msg__TurnSignal__init(message_memory);
}

void TurnSignal__rosidl_typesupport_introspection_c__TurnSignal_fini_function(void * message_memory)
{
  autoware_vehicle_msgs__msg__TurnSignal__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TurnSignal__rosidl_typesupport_introspection_c__TurnSignal_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(autoware_vehicle_msgs__msg__TurnSignal, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs__msg__TurnSignal, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TurnSignal__rosidl_typesupport_introspection_c__TurnSignal_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_vehicle_msgs__msg__TurnSignal),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_vehicle_msgs, msg, TurnSignal)() {
  TurnSignal__rosidl_typesupport_introspection_c__TurnSignal_message_member_array[0].members_ =

...
#include <stddef.h>
#include "autoware_vehicle_msgs/msg/detail/battery_status__rosidl_typesupport_introspection_c.h"
...
#include "autoware_vehicle_msgs/msg/detail/battery_status__struct.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_vehicle_msgs__msg__BatteryStatus__init(message_memory);
}

void BatteryStatus__rosidl_typesupport_introspection_c__BatteryStatus_fini_function(void * message_memory)
{
  autoware_vehicle_msgs__msg__BatteryStatus__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember BatteryStatus__rosidl_typesupport_introspection_c__BatteryStatus_message_member_array[2] = {
  {
    ...
    offsetof(autoware_vehicle_msgs__msg__BatteryStatus, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs__msg__BatteryStatus, energy_level),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers BatteryStatus__rosidl_typesupport_introspection_c__BatteryStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_vehicle_msgs__msg__BatteryStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_vehicle_msgs, msg, BatteryStatus)() {

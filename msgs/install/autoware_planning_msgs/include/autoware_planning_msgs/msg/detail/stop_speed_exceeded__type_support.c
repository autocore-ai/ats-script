...
#include <stddef.h>
#include "autoware_planning_msgs/msg/detail/stop_speed_exceeded__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_planning_msgs__msg__StopSpeedExceeded__init(message_memory);
}

void StopSpeedExceeded__rosidl_typesupport_introspection_c__StopSpeedExceeded_fini_function(void * message_memory)
{
  autoware_planning_msgs__msg__StopSpeedExceeded__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopSpeedExceeded__rosidl_typesupport_introspection_c__StopSpeedExceeded_message_member_array[2] = {
  {
    ...
    offsetof(autoware_planning_msgs__msg__StopSpeedExceeded, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__StopSpeedExceeded, stop_speed_exceeded),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StopSpeedExceeded__rosidl_typesupport_introspection_c__StopSpeedExceeded_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_planning_msgs__msg__StopSpeedExceeded),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, StopSpeedExceeded)() {

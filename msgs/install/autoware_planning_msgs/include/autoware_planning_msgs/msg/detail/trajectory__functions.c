...
{
  autoware_planning_msgs__msg__Trajectory * msg = (autoware_planning_msgs__msg__Trajectory *)malloc(sizeof(autoware_planning_msgs__msg__Trajectory));
  if (!msg) {
    return NULL;
  }
...
autoware_planning_msgs__msg__Trajectory__Sequence__init(autoware_planning_msgs__msg__Trajectory__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_planning_msgs__msg__Trajectory *)calloc(size, sizeof(autoware_planning_msgs__msg__Trajectory));
    if (!data) {
      return false;
    }
...
{
  autoware_planning_msgs__msg__Trajectory__Sequence * array = (autoware_planning_msgs__msg__Trajectory__Sequence *)malloc(sizeof(autoware_planning_msgs__msg__Trajectory__Sequence));
  if (!array) {
    return NULL;
  }

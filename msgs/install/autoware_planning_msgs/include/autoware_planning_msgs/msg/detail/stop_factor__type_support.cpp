...
{
  new (message_memory) autoware_planning_msgs::msg::StopFactor(_init);
}

void StopFactor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_planning_msgs::msg::StopFactor *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StopFactor_message_member_array[3] = {
  {
    ...
    offsetof(autoware_planning_msgs::msg::StopFactor, stop_pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::StopFactor, dist_to_stop_pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::StopFactor, stop_factor_points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StopFactor_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_planning_msgs::msg::StopFactor),
...
get_message_type_support_handle<autoware_planning_msgs::msg::StopFactor>()
{
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::StopFactor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_planning_msgs, msg, StopFactor)() {
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::StopFactor_message_type_support_handle;
}

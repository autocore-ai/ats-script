...
// Member `stop_factors`
#include "autoware_planning_msgs/msg/stop_factor.h"
// Member `stop_factors`
#include "autoware_planning_msgs/msg/detail/stop_factor__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_planning_msgs__msg__StopReason__init(message_memory);
}

void StopReason__rosidl_typesupport_introspection_c__StopReason_fini_function(void * message_memory)
{
  autoware_planning_msgs__msg__StopReason__fini(message_memory);
}

size_t StopReason__rosidl_typesupport_introspection_c__size_function__StopFactor__stop_factors(
  const void * untyped_member)
{
  const autoware_planning_msgs__msg__StopFactor__Sequence * member =
    (const autoware_planning_msgs__msg__StopFactor__Sequence *)(untyped_member);
  return member->size;
}
...
{
  autoware_planning_msgs__msg__StopFactor__Sequence * member =
    (autoware_planning_msgs__msg__StopFactor__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  autoware_planning_msgs__msg__StopFactor__Sequence * member =
    (autoware_planning_msgs__msg__StopFactor__Sequence *)(untyped_member);
  autoware_planning_msgs__msg__StopFactor__Sequence__fini(member);
  return autoware_planning_msgs__msg__StopFactor__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopReason__rosidl_typesupport_introspection_c__StopReason_message_member_array[2] = {
  {
    ...
    offsetof(autoware_planning_msgs__msg__StopReason, reason),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__StopReason, stop_factors),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers StopReason__rosidl_typesupport_introspection_c__StopReason_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_planning_msgs__msg__StopReason),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, StopReason)() {
  StopReason__rosidl_typesupport_introspection_c__StopReason_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, StopFactor)();

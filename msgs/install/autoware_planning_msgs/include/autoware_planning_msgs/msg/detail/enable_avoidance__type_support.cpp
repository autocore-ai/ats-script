...
{
  new (message_memory) autoware_planning_msgs::msg::EnableAvoidance(_init);
}

void EnableAvoidance_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_planning_msgs::msg::EnableAvoidance *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EnableAvoidance_message_member_array[2] = {
  {
    ...
    offsetof(autoware_planning_msgs::msg::EnableAvoidance, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::EnableAvoidance, enable_avoidance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EnableAvoidance_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_planning_msgs::msg::EnableAvoidance),
...
get_message_type_support_handle<autoware_planning_msgs::msg::EnableAvoidance>()
{
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::EnableAvoidance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_planning_msgs, msg, EnableAvoidance)() {
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::EnableAvoidance_message_type_support_handle;
}

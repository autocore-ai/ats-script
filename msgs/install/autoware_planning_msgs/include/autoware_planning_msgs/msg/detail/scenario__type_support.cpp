...
{
  new (message_memory) autoware_planning_msgs::msg::Scenario(_init);
}

void Scenario_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_planning_msgs::msg::Scenario *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Scenario_message_member_array[2] = {
  {
    ...
    offsetof(autoware_planning_msgs::msg::Scenario, current_scenario),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::Scenario, activating_scenarios),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Scenario_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_planning_msgs::msg::Scenario),
...
get_message_type_support_handle<autoware_planning_msgs::msg::Scenario>()
{
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::Scenario_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_planning_msgs, msg, Scenario)() {
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::Scenario_message_type_support_handle;
}

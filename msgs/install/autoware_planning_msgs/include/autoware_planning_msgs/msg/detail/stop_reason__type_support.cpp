...
{
  new (message_memory) autoware_planning_msgs::msg::StopReason(_init);
}

void StopReason_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_planning_msgs::msg::StopReason *>(message_memory);
  typed_message->~StopReason();
}

size_t size_function__StopReason__stop_factors(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<autoware_planning_msgs::msg::StopFactor> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<autoware_planning_msgs::msg::StopFactor> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<autoware_planning_msgs::msg::StopFactor> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StopReason_message_member_array[2] = {
  {
    ...
    offsetof(autoware_planning_msgs::msg::StopReason, reason),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<autoware_planning_msgs::msg::StopFactor>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::StopReason, stop_factors),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StopReason_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_planning_msgs::msg::StopReason),
...
get_message_type_support_handle<autoware_planning_msgs::msg::StopReason>()
{
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::StopReason_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_planning_msgs, msg, StopReason)() {
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::StopReason_message_type_support_handle;
}

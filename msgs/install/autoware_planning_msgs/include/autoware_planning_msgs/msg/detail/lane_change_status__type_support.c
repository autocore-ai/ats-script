...
#include <stddef.h>
#include "autoware_planning_msgs/msg/detail/lane_change_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_planning_msgs__msg__LaneChangeStatus__init(message_memory);
}

void LaneChangeStatus__rosidl_typesupport_introspection_c__LaneChangeStatus_fini_function(void * message_memory)
{
  autoware_planning_msgs__msg__LaneChangeStatus__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember LaneChangeStatus__rosidl_typesupport_introspection_c__LaneChangeStatus_message_member_array[2] = {
  {
    ...
    offsetof(autoware_planning_msgs__msg__LaneChangeStatus, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__LaneChangeStatus, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers LaneChangeStatus__rosidl_typesupport_introspection_c__LaneChangeStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_planning_msgs__msg__LaneChangeStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, LaneChangeStatus)() {

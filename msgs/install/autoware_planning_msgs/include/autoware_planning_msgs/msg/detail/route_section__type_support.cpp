...
{
  new (message_memory) autoware_planning_msgs::msg::RouteSection(_init);
}

void RouteSection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_planning_msgs::msg::RouteSection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RouteSection_message_member_array[3] = {
  {
    ...
    offsetof(autoware_planning_msgs::msg::RouteSection, lane_ids),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::RouteSection, preferred_lane_id),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::RouteSection, continued_lane_ids),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RouteSection_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_planning_msgs::msg::RouteSection),
...
get_message_type_support_handle<autoware_planning_msgs::msg::RouteSection>()
{
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::RouteSection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_planning_msgs, msg, RouteSection)() {
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::RouteSection_message_type_support_handle;
}

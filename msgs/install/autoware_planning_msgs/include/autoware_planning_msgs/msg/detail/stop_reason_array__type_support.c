...
#include <stddef.h>
#include "autoware_planning_msgs/msg/detail/stop_reason_array__rosidl_typesupport_introspection_c.h"
...
#include "autoware_planning_msgs/msg/detail/stop_reason_array__struct.h"
...
// Member `stop_reasons`
#include "autoware_planning_msgs/msg/stop_reason.h"
// Member `stop_reasons`
#include "autoware_planning_msgs/msg/detail/stop_reason__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_planning_msgs__msg__StopReasonArray__init(message_memory);
}

void StopReasonArray__rosidl_typesupport_introspection_c__StopReasonArray_fini_function(void * message_memory)
{
  autoware_planning_msgs__msg__StopReasonArray__fini(message_memory);
}

size_t StopReasonArray__rosidl_typesupport_introspection_c__size_function__StopReason__stop_reasons(
  const void * untyped_member)
{
  const autoware_planning_msgs__msg__StopReason__Sequence * member =
    (const autoware_planning_msgs__msg__StopReason__Sequence *)(untyped_member);
  return member->size;
}
...
{
  autoware_planning_msgs__msg__StopReason__Sequence * member =
    (autoware_planning_msgs__msg__StopReason__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  autoware_planning_msgs__msg__StopReason__Sequence * member =
    (autoware_planning_msgs__msg__StopReason__Sequence *)(untyped_member);
  autoware_planning_msgs__msg__StopReason__Sequence__fini(member);
  return autoware_planning_msgs__msg__StopReason__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopReasonArray__rosidl_typesupport_introspection_c__StopReasonArray_message_member_array[2] = {
  {
    ...
    offsetof(autoware_planning_msgs__msg__StopReasonArray, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__StopReasonArray, stop_reasons),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers StopReasonArray__rosidl_typesupport_introspection_c__StopReasonArray_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_planning_msgs__msg__StopReasonArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, StopReasonArray)() {
  ...
  StopReasonArray__rosidl_typesupport_introspection_c__StopReasonArray_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, StopReason)();

...
// Member 'points'
#include "autoware_planning_msgs/msg/detail/path_point_with_lane_id__traits.hpp"
...
inline void to_yaml(
  const autoware_planning_msgs::msg::PathWithLaneId & msg,
...
inline std::string to_yaml(const autoware_planning_msgs::msg::PathWithLaneId & msg)
{

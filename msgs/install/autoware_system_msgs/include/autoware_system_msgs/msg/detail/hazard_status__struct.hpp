...
#ifndef AUTOWARE_SYSTEM_MSGS__MSG__DETAIL__HAZARD_STATUS__STRUCT_HPP_
#define AUTOWARE_SYSTEM_MSGS__MSG__DETAIL__HAZARD_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_system_msgs__msg__HazardStatus __attribute__((deprecated))
#else
# define DEPRECATED__autoware_system_msgs__msg__HazardStatus __declspec(deprecated)
#endif
...
struct HazardStatus_
{
  ...
  using ConstRawPtr =
    const autoware_system_msgs::msg::HazardStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_system_msgs::msg::HazardStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_system_msgs::msg::HazardStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_system_msgs::msg::HazardStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_system_msgs::msg::HazardStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_system_msgs::msg::HazardStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_system_msgs::msg::HazardStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_system_msgs::msg::HazardStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_system_msgs__msg__HazardStatus
    std::shared_ptr<autoware_system_msgs::msg::HazardStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_system_msgs__msg__HazardStatus
    std::shared_ptr<autoware_system_msgs::msg::HazardStatus_<ContainerAllocator> const>
...
using HazardStatus =
  autoware_system_msgs::msg::HazardStatus_<std::allocator<void>>;
...
#endif  // AUTOWARE_SYSTEM_MSGS__MSG__DETAIL__HAZARD_STATUS__STRUCT_HPP_

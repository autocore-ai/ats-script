  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_system_msgs__msg__HazardStatus__init(message_memory);
}

void HazardStatus__rosidl_typesupport_introspection_c__HazardStatus_fini_function(void * message_memory)
{
  autoware_system_msgs__msg__HazardStatus__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember HazardStatus__rosidl_typesupport_introspection_c__HazardStatus_message_member_array[5] = {
  {
    "level",  // name
    ...
    offsetof(autoware_system_msgs__msg__HazardStatus, level),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_system_msgs__msg__HazardStatus, diagnostics_nf),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_system_msgs__msg__HazardStatus, diagnostics_sf),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_system_msgs__msg__HazardStatus, diagnostics_lf),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_system_msgs__msg__HazardStatus, diagnostics_spf),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers HazardStatus__rosidl_typesupport_introspection_c__HazardStatus_message_members = {
  ...
  5,  // number of fields
  sizeof(autoware_system_msgs__msg__HazardStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_system_msgs, msg, HazardStatus)() {
  HazardStatus__rosidl_typesupport_introspection_c__HazardStatus_message_member_array[1].members_ =
  ...
  HazardStatus__rosidl_typesupport_introspection_c__HazardStatus_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, diagnostic_msgs, msg, DiagnosticStatus)();

...
#include <stddef.h>
#include "autoware_system_msgs/msg/detail/hazard_status_stamped__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_system_msgs__msg__HazardStatusStamped__init(message_memory);
}

void HazardStatusStamped__rosidl_typesupport_introspection_c__HazardStatusStamped_fini_function(void * message_memory)
{
  autoware_system_msgs__msg__HazardStatusStamped__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember HazardStatusStamped__rosidl_typesupport_introspection_c__HazardStatusStamped_message_member_array[2] = {
  {
    ...
    offsetof(autoware_system_msgs__msg__HazardStatusStamped, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_system_msgs__msg__HazardStatusStamped, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers HazardStatusStamped__rosidl_typesupport_introspection_c__HazardStatusStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_system_msgs__msg__HazardStatusStamped),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_system_msgs, msg, HazardStatusStamped)() {

...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DrivingCapability_message_member_array[3] = {
  {
    ...
    offsetof(autoware_system_msgs::msg::DrivingCapability, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<autoware_system_msgs::msg::HazardStatus>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound

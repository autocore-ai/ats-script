...
#include "autoware_debug_msgs/msg/detail/float64_multi_array_stamped__struct.hpp"
...
{
  new (message_memory) autoware_debug_msgs::msg::Float64MultiArrayStamped(_init);
}

void Float64MultiArrayStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_debug_msgs::msg::Float64MultiArrayStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Float64MultiArrayStamped_message_member_array[2] = {
  {
    "stamp",  // name
    ...
    offsetof(autoware_debug_msgs::msg::Float64MultiArrayStamped, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_debug_msgs::msg::Float64MultiArrayStamped, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Float64MultiArrayStamped_message_members = {
  "autoware_debug_msgs::msg",  // message namespace
  "Float64MultiArrayStamped",  // message name
  2,  // number of fields
  sizeof(autoware_debug_msgs::msg::Float64MultiArrayStamped),
...
get_message_type_support_handle<autoware_debug_msgs::msg::Float64MultiArrayStamped>()
{
  return &::autoware_debug_msgs::msg::rosidl_typesupport_introspection_cpp::Float64MultiArrayStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_debug_msgs, msg, Float64MultiArrayStamped)() {
  return &::autoware_debug_msgs::msg::rosidl_typesupport_introspection_cpp::Float64MultiArrayStamped_message_type_support_handle;
}

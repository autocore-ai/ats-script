...
{
  new (message_memory) autoware_debug_msgs::msg::Int32MultiArrayStamped(_init);
}

void Int32MultiArrayStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_debug_msgs::msg::Int32MultiArrayStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Int32MultiArrayStamped_message_member_array[2] = {
  {
    "stamp",  // name
    ...
    offsetof(autoware_debug_msgs::msg::Int32MultiArrayStamped, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_debug_msgs::msg::Int32MultiArrayStamped, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Int32MultiArrayStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_debug_msgs::msg::Int32MultiArrayStamped),
...
get_message_type_support_handle<autoware_debug_msgs::msg::Int32MultiArrayStamped>()
{
  return &::autoware_debug_msgs::msg::rosidl_typesupport_introspection_cpp::Int32MultiArrayStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_debug_msgs, msg, Int32MultiArrayStamped)() {
  return &::autoware_debug_msgs::msg::rosidl_typesupport_introspection_cpp::Int32MultiArrayStamped_message_type_support_handle;
}

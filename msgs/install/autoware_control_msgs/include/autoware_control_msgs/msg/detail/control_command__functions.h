...
#ifndef AUTOWARE_CONTROL_MSGS__MSG__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
#define AUTOWARE_CONTROL_MSGS__MSG__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * autoware_control_msgs__msg__ControlCommand__init().
...
/**
 * It calls
 * autoware_control_msgs__msg__ControlCommand__fini()
 ...
 * autoware_control_msgs__msg__ControlCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_control_msgs__msg__ControlCommand__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_CONTROL_MSGS__MSG__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_

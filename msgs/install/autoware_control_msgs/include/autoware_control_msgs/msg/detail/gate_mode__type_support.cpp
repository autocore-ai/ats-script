...
{
  new (message_memory) autoware_control_msgs::msg::GateMode(_init);
}

void GateMode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_control_msgs::msg::GateMode *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GateMode_message_member_array[1] = {
  {
    ...
    offsetof(autoware_control_msgs::msg::GateMode, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GateMode_message_members = {
  ...
  1,  // number of fields
  sizeof(autoware_control_msgs::msg::GateMode),
...
get_message_type_support_handle<autoware_control_msgs::msg::GateMode>()
{
  return &::autoware_control_msgs::msg::rosidl_typesupport_introspection_cpp::GateMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_control_msgs, msg, GateMode)() {
  return &::autoware_control_msgs::msg::rosidl_typesupport_introspection_cpp::GateMode_message_type_support_handle;
}

...
#include <stddef.h>
#include "autoware_control_msgs/msg/detail/control_command_stamped__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_control_msgs__msg__ControlCommandStamped__init(message_memory);
}

void ControlCommandStamped__rosidl_typesupport_introspection_c__ControlCommandStamped_fini_function(void * message_memory)
{
  autoware_control_msgs__msg__ControlCommandStamped__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ControlCommandStamped__rosidl_typesupport_introspection_c__ControlCommandStamped_message_member_array[2] = {
  {
    ...
    offsetof(autoware_control_msgs__msg__ControlCommandStamped, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_control_msgs__msg__ControlCommandStamped, control),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ControlCommandStamped__rosidl_typesupport_introspection_c__ControlCommandStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_control_msgs__msg__ControlCommandStamped),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_control_msgs, msg, ControlCommandStamped)() {

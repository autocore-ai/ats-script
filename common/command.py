...
START_PERCEPTION = 'cd {}/common/script/;screen -d -m -S perception-test ./run_autoware4_perception.sh'.format(TEST_CASE_PATH)
...
CHECK_PERCEPTION_NODE = 'docker exec {} /bin/bash -c \'source /opt/ros/melodic/setup.bash && source /root/autoware4/devel/setup.bash && export ROS_IP=192.168.50.235 && export ROS_MASTER_URI=http://192.168.50.235:11311 && rosnode list | grep perception\''.format(PERCEPTION_DOCKER_NAME)

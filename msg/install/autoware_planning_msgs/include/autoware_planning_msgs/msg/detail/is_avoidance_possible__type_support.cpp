...
{
  new (message_memory) autoware_planning_msgs::msg::IsAvoidancePossible(_init);
}

void IsAvoidancePossible_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_planning_msgs::msg::IsAvoidancePossible *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IsAvoidancePossible_message_member_array[2] = {
  {
    ...
    offsetof(autoware_planning_msgs::msg::IsAvoidancePossible, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::IsAvoidancePossible, is_avoidance_possible),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers IsAvoidancePossible_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_planning_msgs::msg::IsAvoidancePossible),
...
get_message_type_support_handle<autoware_planning_msgs::msg::IsAvoidancePossible>()
{
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::IsAvoidancePossible_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_planning_msgs, msg, IsAvoidancePossible)() {
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::IsAvoidancePossible_message_type_support_handle;
}

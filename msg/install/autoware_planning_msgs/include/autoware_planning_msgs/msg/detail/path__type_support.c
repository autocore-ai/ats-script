...
#include <stddef.h>
#include "autoware_planning_msgs/msg/detail/path__rosidl_typesupport_introspection_c.h"
...
// Member `points`
#include "autoware_planning_msgs/msg/path_point.h"
// Member `points`
#include "autoware_planning_msgs/msg/detail/path_point__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_planning_msgs__msg__Path__init(message_memory);
}

void Path__rosidl_typesupport_introspection_c__Path_fini_function(void * message_memory)
{
  autoware_planning_msgs__msg__Path__fini(message_memory);
}

size_t Path__rosidl_typesupport_introspection_c__size_function__PathPoint__points(
  const void * untyped_member)
{
  const autoware_planning_msgs__msg__PathPoint__Sequence * member =
    (const autoware_planning_msgs__msg__PathPoint__Sequence *)(untyped_member);
  return member->size;
}
...
{
  autoware_planning_msgs__msg__PathPoint__Sequence * member =
    (autoware_planning_msgs__msg__PathPoint__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  autoware_planning_msgs__msg__PathPoint__Sequence * member =
    (autoware_planning_msgs__msg__PathPoint__Sequence *)(untyped_member);
  autoware_planning_msgs__msg__PathPoint__Sequence__fini(member);
  return autoware_planning_msgs__msg__PathPoint__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember Path__rosidl_typesupport_introspection_c__Path_message_member_array[3] = {
  {
    ...
    offsetof(autoware_planning_msgs__msg__Path, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__Path, points),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__Path, drivable_area),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Path__rosidl_typesupport_introspection_c__Path_message_members = {
  ...
  "Path",  // message name
  3,  // number of fields
  sizeof(autoware_planning_msgs__msg__Path),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, Path)() {
  ...
  Path__rosidl_typesupport_introspection_c__Path_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, PathPoint)();

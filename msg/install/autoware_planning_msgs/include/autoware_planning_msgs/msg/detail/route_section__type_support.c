  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_planning_msgs__msg__RouteSection__init(message_memory);
}

void RouteSection__rosidl_typesupport_introspection_c__RouteSection_fini_function(void * message_memory)
{
  autoware_planning_msgs__msg__RouteSection__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RouteSection__rosidl_typesupport_introspection_c__RouteSection_message_member_array[3] = {
  {
    ...
    offsetof(autoware_planning_msgs__msg__RouteSection, lane_ids),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__RouteSection, preferred_lane_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__RouteSection, continued_lane_ids),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RouteSection__rosidl_typesupport_introspection_c__RouteSection_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_planning_msgs__msg__RouteSection),

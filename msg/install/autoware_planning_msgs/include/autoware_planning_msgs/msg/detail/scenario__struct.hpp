...
#ifndef AUTOWARE_PLANNING_MSGS__MSG__DETAIL__SCENARIO__STRUCT_HPP_
#define AUTOWARE_PLANNING_MSGS__MSG__DETAIL__SCENARIO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_planning_msgs__msg__Scenario __attribute__((deprecated))
#else
# define DEPRECATED__autoware_planning_msgs__msg__Scenario __declspec(deprecated)
#endif
...
struct Scenario_
{
  ...
  // pointer types
  using RawPtr =
    autoware_planning_msgs::msg::Scenario_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_planning_msgs::msg::Scenario_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_planning_msgs::msg::Scenario_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_planning_msgs::msg::Scenario_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_planning_msgs::msg::Scenario_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_planning_msgs::msg::Scenario_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_planning_msgs::msg::Scenario_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_planning_msgs::msg::Scenario_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_planning_msgs::msg::Scenario_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_planning_msgs__msg__Scenario
    std::shared_ptr<autoware_planning_msgs::msg::Scenario_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_planning_msgs__msg__Scenario
    std::shared_ptr<autoware_planning_msgs::msg::Scenario_<ContainerAllocator> const>
...
using Scenario =
  autoware_planning_msgs::msg::Scenario_<std::allocator<void>>;
...
#endif  // AUTOWARE_PLANNING_MSGS__MSG__DETAIL__SCENARIO__STRUCT_HPP_

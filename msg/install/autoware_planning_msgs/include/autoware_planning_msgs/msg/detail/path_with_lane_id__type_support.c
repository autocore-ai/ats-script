...
#include <stddef.h>
#include "autoware_planning_msgs/msg/detail/path_with_lane_id__rosidl_typesupport_introspection_c.h"
...
#include "autoware_planning_msgs/msg/detail/path_with_lane_id__struct.h"
...
// Member `points`
#include "autoware_planning_msgs/msg/path_point_with_lane_id.h"
// Member `points`
#include "autoware_planning_msgs/msg/detail/path_point_with_lane_id__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_planning_msgs__msg__PathWithLaneId__init(message_memory);
}

void PathWithLaneId__rosidl_typesupport_introspection_c__PathWithLaneId_fini_function(void * message_memory)
{
  autoware_planning_msgs__msg__PathWithLaneId__fini(message_memory);
}

size_t PathWithLaneId__rosidl_typesupport_introspection_c__size_function__PathPointWithLaneId__points(
  const void * untyped_member)
{
  const autoware_planning_msgs__msg__PathPointWithLaneId__Sequence * member =
    (const autoware_planning_msgs__msg__PathPointWithLaneId__Sequence *)(untyped_member);
  return member->size;
}
...
{
  autoware_planning_msgs__msg__PathPointWithLaneId__Sequence * member =
    (autoware_planning_msgs__msg__PathPointWithLaneId__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  autoware_planning_msgs__msg__PathPointWithLaneId__Sequence * member =
    (autoware_planning_msgs__msg__PathPointWithLaneId__Sequence *)(untyped_member);
  autoware_planning_msgs__msg__PathPointWithLaneId__Sequence__fini(member);
  return autoware_planning_msgs__msg__PathPointWithLaneId__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember PathWithLaneId__rosidl_typesupport_introspection_c__PathWithLaneId_message_member_array[3] = {
  {
    ...
    offsetof(autoware_planning_msgs__msg__PathWithLaneId, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__PathWithLaneId, points),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__PathWithLaneId, drivable_area),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers PathWithLaneId__rosidl_typesupport_introspection_c__PathWithLaneId_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_planning_msgs__msg__PathWithLaneId),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, PathWithLaneId)() {
  ...
  PathWithLaneId__rosidl_typesupport_introspection_c__PathWithLaneId_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_planning_msgs, msg, PathPointWithLaneId)();

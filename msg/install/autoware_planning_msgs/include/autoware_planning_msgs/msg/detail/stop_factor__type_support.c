  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_planning_msgs__msg__StopFactor__init(message_memory);
}

void StopFactor__rosidl_typesupport_introspection_c__StopFactor_fini_function(void * message_memory)
{
  autoware_planning_msgs__msg__StopFactor__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopFactor__rosidl_typesupport_introspection_c__StopFactor_message_member_array[3] = {
  {
    ...
    offsetof(autoware_planning_msgs__msg__StopFactor, stop_pose),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__StopFactor, dist_to_stop_pose),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs__msg__StopFactor, stop_factor_points),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers StopFactor__rosidl_typesupport_introspection_c__StopFactor_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_planning_msgs__msg__StopFactor),

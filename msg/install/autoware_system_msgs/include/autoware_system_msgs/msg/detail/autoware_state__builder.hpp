...
{
public:
  explicit Init_AutowareState_msg(::autoware_system_msgs::msg::AutowareState & msg)
  : msg_(msg)
  {}
  ::autoware_system_msgs::msg::AutowareState msg(::autoware_system_msgs::msg::AutowareState::_msg_type arg)
  {
...
public:
  ...
  {}
  Init_AutowareState_msg state(::autoware_system_msgs::msg::AutowareState::_state_type arg)
  {
...
{
  return autoware_system_msgs::msg::builder::Init_AutowareState_state();
}

...
#include <stddef.h>
#include "autoware_debug_msgs/msg/detail/float64_multi_array_stamped__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_debug_msgs__msg__Float64MultiArrayStamped__init(message_memory);
}
...
{
  autoware_debug_msgs__msg__Float64MultiArrayStamped__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Float64MultiArrayStamped__rosidl_typesupport_introspection_c__Float64MultiArrayStamped_message_member_array[2] = {
  {
    "stamp",  // name
    ...
    offsetof(autoware_debug_msgs__msg__Float64MultiArrayStamped, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_debug_msgs__msg__Float64MultiArrayStamped, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Float64MultiArrayStamped__rosidl_typesupport_introspection_c__Float64MultiArrayStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_debug_msgs__msg__Float64MultiArrayStamped),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_debug_msgs, msg, Float64MultiArrayStamped)() {

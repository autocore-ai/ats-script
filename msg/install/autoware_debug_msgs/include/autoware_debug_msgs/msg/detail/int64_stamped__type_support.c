...
#include <stddef.h>
#include "autoware_debug_msgs/msg/detail/int64_stamped__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_debug_msgs__msg__Int64Stamped__init(message_memory);
}

void Int64Stamped__rosidl_typesupport_introspection_c__Int64Stamped_fini_function(void * message_memory)
{
  autoware_debug_msgs__msg__Int64Stamped__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Int64Stamped__rosidl_typesupport_introspection_c__Int64Stamped_message_member_array[2] = {
  {
    ...
    offsetof(autoware_debug_msgs__msg__Int64Stamped, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_debug_msgs__msg__Int64Stamped, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Int64Stamped__rosidl_typesupport_introspection_c__Int64Stamped_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_debug_msgs__msg__Int64Stamped),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_debug_msgs, msg, Int64Stamped)() {

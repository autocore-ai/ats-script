...
#include <stddef.h>
#include "autoware_debug_msgs/msg/detail/string_stamped__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_debug_msgs__msg__StringStamped__init(message_memory);
}

void StringStamped__rosidl_typesupport_introspection_c__StringStamped_fini_function(void * message_memory)
{
  autoware_debug_msgs__msg__StringStamped__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StringStamped__rosidl_typesupport_introspection_c__StringStamped_message_member_array[2] = {
  {
    ...
    offsetof(autoware_debug_msgs__msg__StringStamped, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_debug_msgs__msg__StringStamped, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StringStamped__rosidl_typesupport_introspection_c__StringStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_debug_msgs__msg__StringStamped),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_debug_msgs, msg, StringStamped)() {

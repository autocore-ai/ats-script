...
#include "autoware_debug_msgs/msg/detail/int32_stamped__struct.hpp"
...
{
  new (message_memory) autoware_debug_msgs::msg::Int32Stamped(_init);
}

void Int32Stamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_debug_msgs::msg::Int32Stamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Int32Stamped_message_member_array[2] = {
  {
    ...
    offsetof(autoware_debug_msgs::msg::Int32Stamped, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_debug_msgs::msg::Int32Stamped, data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Int32Stamped_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_debug_msgs::msg::Int32Stamped),
...
get_message_type_support_handle<autoware_debug_msgs::msg::Int32Stamped>()
{
  return &::autoware_debug_msgs::msg::rosidl_typesupport_introspection_cpp::Int32Stamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_debug_msgs, msg, Int32Stamped)() {
  return &::autoware_debug_msgs::msg::rosidl_typesupport_introspection_cpp::Int32Stamped_message_type_support_handle;
}

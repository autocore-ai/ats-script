...
#include "autoware_debug_msgs/msg/detail/bool_stamped__struct.hpp"
...
{
  new (message_memory) autoware_debug_msgs::msg::BoolStamped(_init);
}

void BoolStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_debug_msgs::msg::BoolStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoolStamped_message_member_array[2] = {
  {
    ...
    offsetof(autoware_debug_msgs::msg::BoolStamped, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_debug_msgs::msg::BoolStamped, data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoolStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_debug_msgs::msg::BoolStamped),
...
get_message_type_support_handle<autoware_debug_msgs::msg::BoolStamped>()
{
  return &::autoware_debug_msgs::msg::rosidl_typesupport_introspection_cpp::BoolStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_debug_msgs, msg, BoolStamped)() {
  return &::autoware_debug_msgs::msg::rosidl_typesupport_introspection_cpp::BoolStamped_message_type_support_handle;
}

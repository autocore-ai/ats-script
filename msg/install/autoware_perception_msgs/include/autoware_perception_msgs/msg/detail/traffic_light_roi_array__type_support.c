...
#include <stddef.h>
#include "autoware_perception_msgs/msg/detail/traffic_light_roi_array__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_perception_msgs__msg__TrafficLightRoiArray__init(message_memory);
}

void TrafficLightRoiArray__rosidl_typesupport_introspection_c__TrafficLightRoiArray_fini_function(void * message_memory)
{
  autoware_perception_msgs__msg__TrafficLightRoiArray__fini(message_memory);
}

size_t TrafficLightRoiArray__rosidl_typesupport_introspection_c__size_function__TrafficLightRoi__rois(
  const void * untyped_member)
{
  const autoware_perception_msgs__msg__TrafficLightRoi__Sequence * member =
    (const autoware_perception_msgs__msg__TrafficLightRoi__Sequence *)(untyped_member);
  return member->size;
}
...
{
  autoware_perception_msgs__msg__TrafficLightRoi__Sequence * member =
    (autoware_perception_msgs__msg__TrafficLightRoi__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  autoware_perception_msgs__msg__TrafficLightRoi__Sequence * member =
    (autoware_perception_msgs__msg__TrafficLightRoi__Sequence *)(untyped_member);
  autoware_perception_msgs__msg__TrafficLightRoi__Sequence__fini(member);
  return autoware_perception_msgs__msg__TrafficLightRoi__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrafficLightRoiArray__rosidl_typesupport_introspection_c__TrafficLightRoiArray_message_member_array[2] = {
  {
    ...
    offsetof(autoware_perception_msgs__msg__TrafficLightRoiArray, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs__msg__TrafficLightRoiArray, rois),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers TrafficLightRoiArray__rosidl_typesupport_introspection_c__TrafficLightRoiArray_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_perception_msgs__msg__TrafficLightRoiArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_perception_msgs, msg, TrafficLightRoiArray)() {

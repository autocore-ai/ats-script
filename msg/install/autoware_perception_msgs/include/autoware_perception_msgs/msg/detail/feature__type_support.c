  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_perception_msgs__msg__Feature__init(message_memory);
}

void Feature__rosidl_typesupport_introspection_c__Feature_fini_function(void * message_memory)
{
  autoware_perception_msgs__msg__Feature__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Feature__rosidl_typesupport_introspection_c__Feature_message_member_array[2] = {
  {
    ...
    offsetof(autoware_perception_msgs__msg__Feature, cluster),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs__msg__Feature, roi),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Feature__rosidl_typesupport_introspection_c__Feature_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_perception_msgs__msg__Feature),

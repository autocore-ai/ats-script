...
#ifndef AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__STATE__STRUCT_HPP_
#define AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_perception_msgs__msg__State __attribute__((deprecated))
#else
# define DEPRECATED__autoware_perception_msgs__msg__State __declspec(deprecated)
#endif
...
struct State_
{
  ...
  using _predicted_paths_type =
    std::vector<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>>::other>;
  ...
  Type & set__predicted_paths(
    const std::vector<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>>::other> & _arg)
  {
  ...
  using ConstRawPtr =
    const autoware_perception_msgs::msg::State_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_perception_msgs::msg::State_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_perception_msgs::msg::State_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_perception_msgs::msg::State_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_perception_msgs::msg::State_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_perception_msgs::msg::State_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_perception_msgs::msg::State_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_perception_msgs::msg::State_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_perception_msgs__msg__State
    std::shared_ptr<autoware_perception_msgs::msg::State_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_perception_msgs__msg__State
    std::shared_ptr<autoware_perception_msgs::msg::State_<ContainerAllocator> const>
...
using State =
  autoware_perception_msgs::msg::State_<std::allocator<void>>;
...
#endif  // AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__STATE__STRUCT_HPP_

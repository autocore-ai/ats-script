...
import common.ODD.future_way.fw_action as fw_act
import common.ODD.config as odd_conf


logger = logging.getLogger()
case_dir = odd_conf.EXEC_CASE_SCENE[odd_conf.EXEC_CASE_TYPE]['case_dir']
CASE_LIST = generate_case_data('{case_path}/{case_dir}/fw_cases.csv'.format(case_path=odd_conf.ODD_CSV_CASES,
                                                                                  case_dir=case_dir))
bag_dir = odd_conf.EXEC_CASE_SCENE[odd_conf.EXEC_CASE_TYPE]['bag_dir']
BAG_BASE_PATH = '{bag_path}/{bag_dir}'.format(bag_path=odd_conf.BAG_PATH, bag_dir=bag_dir)
...
def make_test_case(story, case_data, case_level, case_desc):
    ...
    def test_future_way(fw_env_opt, case_data):
        ...
        case_bag_record_path = '/home/duan/PycharmProjects/autotest/bags/fw/test_future_way_first/result_2021_04_08_18_08_50'
